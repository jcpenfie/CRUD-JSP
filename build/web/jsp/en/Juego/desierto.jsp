    ...
    <body>
        ...
        <div class="box2">
            <%
                switch (mensaje) {
                    case 0:
                        out.print("<br><div class=\"mensaje\"><span>Somehow, unknown to all of us, you are in the middle of a small village with a 🎺 (trumpet) in hand.</span></div><br>");
                        break;
                    case 1:
                        out.print("<br><div class=\"mensaje\"><span>An unknown force makes you move your arm so hard that the 🎺 (trumpet) shoots out,</span></div><br>");
                        break;
                    case 2:
                        ...
                        switch (opc) {
                            case "h":
                                if (mensaje > 5 && contC > 0) {
                                    ...
                                    contC++;
                                    out.print("<br><div class=\"mensaje\"><span>The house seems to be <b>deserted</b> 🥁<em>*Ba Dum Tss!*</em>🥁</span></div>");
                                }
                                break;
                            case "f":
                                out.print("<br><div class=\"mensaje\"><span>I was not in the bushes 🤔</span></div>");
                                break;
                            case "p":
                                out.print("<br><div class=\"mensaje\"><span>You almost fell into the well and it wasn't even here 🤷‍♀️</span></div>");
                                break;
                            case "r":
                                ...
                                break;
                            default:
                                    out.print("<br><div class=\"mensaje\"><span>The sand makes the search difficult 🔎</span></div>");
                                break;
                        }
                        out.print("<h1>Movements: " + (mensaje - 3) + "</h1>");
                        out.print("<table><tr>");

        ...
        <div class="box">
            <%
                ...
                if ((userbool) || (passbool) || (emailbool)) {
                    out.print("<h1>Account already created</h1><br><a href=\"login.jsp\"><div class=\"btn\">Go Back</div></a><a href=\"login.jsp\"><a href=\"crearCuenta.jsp\"><div id=\"btn2\">Create Account</div></a>");
                } else {
                    try {
                        String dirActual = getServletContext().getRealPath("/") + "datos.txt";
                        Clases.Metodos.guardarDato(user, dirActual);
                    } catch (Exception e) {
                        out.print("<h1>Could not write to file</h1>");
                    }

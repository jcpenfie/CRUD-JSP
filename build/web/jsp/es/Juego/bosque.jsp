    ...
    <body>
        ...
        <div class="box2">
            <%
                switch (mensaje) {
                    case 0:
                        out.print("<br><div class=\"mensaje\"><span>De alguna forma que desconocemos todos estás en mitad del bosque con un 💍 (anillo) en la mano.</span></div><br>");
                        break;
                    case 1:
                        out.print("<br><div class=\"mensaje\"><span>Una fuerza desconocida hace que muevas el brazo tan fuerte que el 💍 (anillo) sale disparado,</span></div><br>");
                        break;
                    case 2:
                        ...
                        switch (opc) {
                            case "h":
                                if (mensaje > 5 && contC > 0) {
                                    ...
                                    contC++;
                                    out.print("<br><div class=\"mensaje\"><span>La casa parece que está <em>abandonado</em> 😰</span></div>");
                                }
                                break;
                            case "f":
                                out.print("<br><div class=\"mensaje\"><span>Entre las flores no está (esperemos que no sean <b>venenosas</b> 🤔)</span></div>");
                                break;
                            case "r":
                                ...
                                break;
                            default:
                                out.print("<br><div class=\"mensaje\"><span>Miras entre el césped y no hay nada</span></div>");
                                break;
                        }
                        out.print("<h1>Movimientos: " + (mensaje - 3) + "</h1>");
                        out.print("<table><tr>");

...
<html>
    ...
    <body>
        ...
        <img src="../../img/text.gif" alt="Título" width="318" height="57"/>
        <div class="box">
            <%
                if (user.startsWith("INV")) {
                    out.print("<a href=\"Juego/bosque.jsp\"><div class=\"btn\"> <i class=\"fas fa-play\"></i>&nbsp; Jugar</div></a>");
                } else {
                    out.print("<a href=\"Juego/validarJuego.jsp\"><div class=\"btn\"> <i class=\"fas fa-play\"></i>&nbsp; Jugar</div></a>");
                }
            %>

            <a href="clasificacion.jsp">
                <div class="btnMorado"><i class="fas fa-trophy"></i>&nbsp; Clasificación</div>
            </a>

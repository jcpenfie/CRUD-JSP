    ...
    <body>
        <div class="box">
            ...
            <%
                ...
                if ((!emailbool)) {
                    out.print("<h1>Datos Erróneos</h1><br><a href=\"recuperarEmailVerificar.jsp\"><div class=\"btn\">Volver</div></a><a href=\"crearCuenta.jsp\"><div id=\"btn2\">Crear Cuenta</div></a>");
                } else {
                    out.print("<h1>Contraseña cambiada con éxito</h1><br><a href=\"../login.jsp\"><div class=\"btn\">Volver al inicio</div></a>");
                }

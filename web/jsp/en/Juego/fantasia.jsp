                        ...
                        switch (opc) {
                            case "h":
                                if (mensaje > 5 && contC > 0) {
                                    ...
                                    contC++;
                                    out.print("<br><div class=\"mensaje\"><span>You were out of <b>your ship</b> when it happened</span></div>");
                                }
                                break;
                            case "f":
                                out.print("<br><div class=\"mensaje\"><span>This planet has 🎩 of colors instead of 🌼🌷. You look for and it is not</span></div>");
                                break;
                            case "r":
                                ...
                                switch (contR) {
                                    ...
                                    default:
                                        contR++;
                                        out.print("<br><div class=\"mensaje\"><span>You ask the unicorn, seriously 🤦‍♂️?</span></div>");
                                        break;
                                }
                                break;
                            default:
                                out.print("<br><div class=\"mensaje\"><span>This flat planet is a bit empty</span></div>");
                                break;
                        }
                        out.print("<h1>Movements: " + (mensaje - 3) + "</h1>");
                        out.print("<table><tr>");

                ...
                <%
                    ...
                    if (!(userbool) || !(passbool)) {
                       response.sendRedirect("login.jsp");
                        ...
                        out.print("<h1>Correct data</h1><br> <img src=\"../../img/loading.gif\" alt=\"Loading\" width=\"64\" height=\"64\"><br><h5>If it does not change the page, click continue:</h5><button type=\"submit\" id=\"btn3\">Continuar</button>");

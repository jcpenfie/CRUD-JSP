...
<html>
    ...
    <body>
        <ul>
            ...
            %>
            <li style="float:right"><a class="active" href="http://localhost:8080/PrectoFinalXampp/index.jsp"><i class="fas fa-sign-out-alt"></i> Salir</a></li>
        </ul>
        <br><br><br><br>
        <div class="box">
            <img src="../../../img/estilo.gif" alt="Clasificacion" width="250" height="45">
            <a href="bosque.jsp?opc=g&j=0&i=0">
                <div class="btn"> <i class="fas fa-tree"></i></i>&nbsp; Bosque</div>
            </a>
            <a href="desierto.jsp?opc=g&j=0&i=0">
                <div class="btnAmarillo"> <i class="fas fa-thermometer-full"></i>&nbsp; Desierto</div>
            </a>
            <a href="fantasia.jsp?opc=g&j=0&i=0">
                <div class="btnMorado"> <i class="fas fa-magic"></i>&nbsp; Fantasía</div>
            </a>
            <a href="nevado.jsp?opc=g&j=0&i=0">
                <div class="btnAzul"> <i class="fas fa-snowflake"></i>&nbsp; Nevado</div>
            </a>

            <a href="../menu.jsp?opc=g&j=0&i=0">
                <div class="btnRojo"><i class="fas fa-undo-alt"></i>&nbsp; Volver</div>
            </a>
        </div>
    </body>
</html>
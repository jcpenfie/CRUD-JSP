...
<html>
    ...
    <body style="margin-top: 30px; background-color:#3498db;">      
        ...
        <div class="modal-dialog">            
            <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target="#myModal">Nuevo Registro</button>
        </div>  
                ...
                <tbody id="tbodys">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            ...
                            <a href="Editar.jsp?user=<%= rs.getString("user")%>" class="btn btn-primary">Editar</a>
                            <a href="Delete.jsp?user=<%= rs.getString("user")%>" class="btn btn-danger">Borrar</a>
                        </td>
                    </tr>
                    <%}%>
            </table>
        ...
        <div class="modal-dialog">            
            <a href="../menu.jsp"> <button type="button" class="btn btn-danger">Volver</button> </a>
        </div>
